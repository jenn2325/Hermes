...
<br>
2. Store Allocation 
We crapped global Hermès store allocation data from *****. Since our focus is on Hermès’ performance in 2020, we also collected data of new stores that was opened in year 2020.
...
<br>
Financial Statements contains valuable information about a company’s performance. We obtained Hermès’ Income Statement and Balance Sheet in year 2019 and 2020 from Hermès annual reports.
...
**6. Stock Information**
<br>
We would like to see how did Hermès’ stock prices perform comparing to other relative stock prices such as stock market index and relative French based luxury goods corporations’ stock. We obtained French Stock Index, S&P 500, LVMH(owns LV, Loewe, Dior etc.) stock and Kering(owns Gucci, Balenciaga, YSL and etc.) stock using `quantmod` package in R.
...
## CAC40 FRENCH INDEX
getSymbols("^FCHI", from = "2010-01-01",to='2021-01-01')

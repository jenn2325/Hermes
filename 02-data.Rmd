...
write.csv(key_figutres.20,"data:raw/2020_key_figures.csv")
key_figutres.20
```
...
write.csv(key2020h1,"data:raw/2020_Half_Year_key_figures.csv")
key2020h1
```
...
key2019
write.csv(key2019,"data:raw/2019_key_figures.csv")
```
...
georaphical_rev_20
write.csv(georaphical_rev_20,"data:raw/2020_Rev_Geo.csv")
```
...
geo_first
write.csv(geo_first,"data:raw/2020_Q1_Rev_Geo.csv")
```
...
write.csv(secgeo,"data:raw/2020_Q2_Rev_Geo.csv")
```   
...
write.csv(geo_third,"data:raw/2020_Q3_Rev_Geo.csv")
```
...
geo_fourth = get_quarter(url4, c(6), c(17:26))
write.csv(geo_fourth,"data:raw/2020_Q4_Rev_Geo.csv")
```
...
write.csv(my_data,"data:raw/2010_to_2020_Rev_Geo.csv")
```
...
sector_rev_20
write.csv(sector_rev_20, "data:raw/2020_Rev_Sector.csv")
```

### 2020 1st Quarter Revenue by Sector(Rachel)
```{r}
sector_first = get_quarter(url1, c(4), c(19:27))
write.csv(sector_first,"data:raw/2020_Q1_Rev_Sector.csv")
```
...
write.csv(secsector,"data:raw/2020_Q2_Rev_Sector.csv")
```
...
sector_third
write.csv(sector_third,"data:raw/2020_Q3_Rev_Sector.csv")
```


### 2020 4th Quarter Revenue by Sector(Rachel)
```{r}
sector_fourth = get_quarter(url4, c(7), c(16:24))
write.csv(sector_fourth,"data:raw/2020_Q4_Rev_Sector.csv")
```
...
write.csv(incomestatement_20,"data:raw/2020_income_statementr.csv")
...
write.csv(comprehensive_income_20,"data:raw/2020_comprehensice_income.csv")
```
...
write.csv(balance_sheet_asset_20,"data:raw/2020_balance_sheet_asset.csv")
balance_sheet_liability_20 <- PDF[25:51] %>% 
  strsplit(split = "\\s{2,}") %>% 
  plyr::ldply()
colnames(balance_sheet_liability_20) <- c("category","31/12/2020","31/12/2019")
write.csv(balance_sheet_liability_20,"data:raw/2020_balance_sheet_liability.csv")
```
...
write.csv(cash_flows_20,"data:raw/2020_cash_flows.csv")
```
...
write.csv(incomestatement_19,"data:raw/2019_income_statement.csv")
```
...
write.csv(comprehensive_income_19,"data:raw/2019_comprehensive_income.csv")
```
...
write.csv(balance_sheet_asset_19,"data:raw/2019_balance_sheet_asset.csv")
...
write.csv(balance_sheet_liability_19,"data:raw/2019_balance_sheet_liability.csv")
```
...
write.csv(cash_flows_19,"data:raw/2019_cash_flows.csv")
```
